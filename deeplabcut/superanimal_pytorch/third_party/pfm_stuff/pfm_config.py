...
# learning policy
lr_config = dict(
    policy="step", warmup="linear", warmup_iters=500, warmup_ratio=0.001, step=[60, 80]
)
total_epochs = 100
log_config = dict(
    interval=1,
...
data_root = "/mnt/md0/shaokai/fixed_pfm_10percent/"
dataset_info = "/mnt/md0/shaokai/fixed_pfm_10percent/dataset.json"
